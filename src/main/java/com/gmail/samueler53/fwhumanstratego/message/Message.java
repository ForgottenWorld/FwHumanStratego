...
public enum Message {
    ...
    GAME_NEWGAME(ChatColor.GREEN + "E' stato creato un nuovo game, fai /hs join per potere accedere", true),
    ...
    GAME_DESERTER(ChatColor.GREEN + "{}" + " e' un disertore!", true),
    GAME_TREASURESAVED(ChatColor.GREEN + "Il tesoro che era stato rubato da " + "{}" + " e' stato salvato", true),
    GAME_ODDPLAYERS(MessageUtils.formatErrorMessage("C'e' un numero dispari di giocatori oppure meno di 4"), true),
    ...
    GAME_STEALHISWOOL(ChatColor.GREEN + "Non puoi rubare la tua stessa lana", true),
